    ...
    <footer className="bg-[hsl(220_16%_4%)] text-foreground py-16 md:py-20 px-4 border-t border-primary/25 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="relative mt-20 pt-10">
          <svg
            aria-hidden="true"
            viewBox="345 85 345 650"
            fill="currentColor"
            preserveAspectRatio="xMidYMax meet"
            className="pointer-events-none absolute right-4 sm:right-10 md:right-16 -top-[7.5rem] h-32 w-16 sm:-top-[8.5rem] sm:h-36 sm:w-[4.5rem] md:-top-[10.5rem] md:h-44 md:w-24 text-primary"
          >
